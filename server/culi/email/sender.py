...
import structlog
from culi.config import EmailSender as EmailSenderType
...
DEFAULT_REPLY_TO_NAME = "Culi Chatbot Support"
DEFAULT_REPLY_TO_EMAIL_ADDRESS = "culi@lampforge.com"
...
class ResendEmailSender(EmailSender):
    ...
    def send_to_user(
        ...
        *,
        ...
        html_content: str,
        from_name: str = DEFAULT_FROM_NAME,
        from_email_addr: str = "culi@lampforge.com",
        email_headers: dict[str, str] = {},
        reply_to_name: str | None = DEFAULT_REPLY_TO_NAME,
        reply_to_email_addr: str | None = DEFAULT_REPLY_TO_EMAIL_ADDRESS,
    ) -> None:
